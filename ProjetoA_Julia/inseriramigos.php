...
<div class="main-content">
    <?php
        if($_POST["cxamigo"] != ""){
            ...
            if ($query) {
                echo "<div class='mensagem sucesso'>Dados cadastrados com sucesso!<br><a href='telaamigos.php'>Voltar</a></div>";
            } else {
                echo "<div class='mensagem erro'>Erro ao cadastrar os dados: " . mysqli_error($conn) . "<br><a href='telaamigos.php'>Voltar</a></div>";
            }
        } else {
            echo "<div class='mensagem erro'>Dados não cadastrados! Preencha todos os campos.<br><a href='telaamigos.php'>Voltar</a></div>";
        }
    ?>
</div>
