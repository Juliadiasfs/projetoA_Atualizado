    ...
    <div class="mensagem-container">
        ...
        ?>
            <form action="alteraramigos.php" method="POST">
                ...
                <a href="excluiramigos.php?id=<?php echo $linha['cod']; ?>">Excluir</a></p>
            </form>
        <?php
                } else {
                    echo "<div class='mensagem'><h2>Amigo não encontrado. Verifique o nome e tente novamente.</h2><a href='telaamigos.php'>Voltar</a></div>";
                }
            }
        ?>
    </div>
