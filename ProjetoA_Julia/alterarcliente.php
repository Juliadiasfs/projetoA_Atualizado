...
<div class="main-content"><?php
    ...
    if($executar){
        echo "<div class='mensagem sucesso'>Dados alterados com sucesso!<br><a href='telacaduser.php'>Voltar</a></div>";
    } else {
        echo "<div class='mensagem erro'>Erro ao alterar os dados: " . mysqli_error($conn) . "<br><a href='telacaduser.php'>Voltar</a></div>";
    }
    ?>
</div>
