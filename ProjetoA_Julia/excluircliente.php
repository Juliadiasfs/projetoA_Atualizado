...
if ($executar) {
    echo "<div class='mensagem sucesso'>Cliente excluído com sucesso!<br><a href='telacaduser.php'>Voltar</a></div>";
} else {
    echo "<div class='mensagem erro'>Erro ao excluir o cliente: " . mysqli_error($conn) . "<br><a href='telacaduser.php'>Voltar</a></div>";
}
?>
</div>
