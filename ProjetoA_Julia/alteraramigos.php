...
<div class="main-content">
    ...
    if($executar){
        echo "<div class='mensagem sucesso'>Dados alterados com sucesso!<br><a href='telaamigos.php'>Voltar</a></div>";
    } else {
        echo "<div class='mensagem erro'>Erro ao alterar os dados: " . mysqli_error($conn) . "<br><a href='telaamigos.php'>Voltar</a></div>";
    }
    ?>
</div>
