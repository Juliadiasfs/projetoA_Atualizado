...
<?php
 ...
 $id= $_GET["id"];
 $excluir= "DELETE FROM tbcomercial WHERE cod='$id'";
 $executar = mysqli_query($conn,$excluir);
 if ($executar) {
    echo "<div class='mensagem sucesso'>Comércio excluído com sucesso!<br><a href='telacadcomercial.php'>Voltar</a></div>";
} else {
    echo "<div class='mensagem erro'>Erro ao excluir o comércio: " . mysqli_error($conn) . "<br><a href='telacadcomercial.php'>Voltar</a></div>";
}
?>
</div>
